...
// A variável categoria deve estar dentro de uma função. A execução do programa deve imprimir os detalhes 
// do produto na ordem correta (com quebra de linha): Produto Categoria Código do Produto.

var produto = "Carro";
const codigoProduto = 1234456;

function exibirCategoria() {
    let categoria = "Chevrolet";
    return categoria;
}
